...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createItemRow(elementType, title, htmlClass, typew) {
        ...
        //makeLabelsClickableTxtBoxes();
    //    
    //function makeLabelsClickableTxtBoxes () {
    //    var labels = document.getElementsByClassName('todoli');
    //    [].forEach.call(labels, (li)=>{
    //        li.addEventListener('click', hideLblShowText);
    //        console.log(li);
    //    });
    //}  
